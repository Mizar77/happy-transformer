...
from happytransformer.absa.trainer import ABSATrainer
...
class HappyAspectBasedSentimentAnalysis(HappyTransformer):
    """
    A user facing class for aspect based sentiment analysis
    """
